...
(defun (main :int) ()
  (declare ()
           ...
           (float-x :float) 2.5f
           (float-y :float) 3.5f
           (double-x :double) 1.234
           (double-y :double) 4.567
           (int-result :int) (@|foo_INT| int-x int-y) ; FIXME It has to be @|foo-INT|!
           (float-result :float) (@|foo_FLOAT| float-x float-y)       ; FIXME
           (double-result :double) (@|foo_DOUBLE| double-x double-y)) ; FIXME
